...
# MAGIC - Navigate to the parent notebook [here](#notebook/3118490411230126) (If you launched the AutoML experiment using the Experiments UI, this link isn't very useful.)
...
X_train, X_val, y_train, y_val = train_test_split(split_X, split_y, random_state=732165669, stratify=split_y)
...
# MAGIC - All the runs are logged under [this MLflow experiment](#mlflow/experiments/3118490411230128/s?orderByKey=metrics.%60val_f1_score%60&orderByAsc=false)
...
xgbc_classifier = XGBClassifier(
  learning_rate=0.010620455952101772,
  max_depth=6,
  min_child_weight=8,
  subsample=0.8444475497011821,
  random_state=732165669,
)
